...
export default function ScientificProgram() {
  const programData = [
    ...
    { 
      time: "16h30-16h45", 
      activity: "Chair: Pr. Rached Ben Hassen & Pr. Mounir ELACHABY\nOpening Ceremony: ICCME 2024" 
    },
    { 
      time: "16h45-17h20", 
      activity: "Plenary Lecture 1: \"Cellulosic nanomaterials as coating formulations for slow-release fertilizers with enhanced nutrients use and agronomic efficiencies\"\nPr. Mounir ELACHABY (University Mohammed VI Polytechnic-Morocco)" 
    },
    {
      time: "17h20-18h15",
